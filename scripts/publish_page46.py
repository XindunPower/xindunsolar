#!/usr/bin/env python3
"""Publish xindun-power news page 46 articles to Spanish WordPress (cat 89)."""
...
RESULTS_PATH = Path("/tmp/page46_results.json")
...
# Compress-only: product showcase with casing text only (2,0); product lineup URL-only (4,0);
# factory assembly photo (4,1).
DUOMI_MAP = {
    (0, 0): (
        "Translate marketing overlay only to Spanish: "
        "'Work without battery'→'Trabaja sin batería'. "
        "Keep xindun GREEN POWER logo, solar panels background, product on wheels, "
        "red forbidden-battery icon, and product casing text ('SOLAR INVERTER', LCD) "
        "unchanged. Do not redesign."
    ),
    (1, 0): (
        "Translate marketing overlay badge only to Spanish: "
        "'3-Phase'→'Trifásico'. Keep '3KW-160KW' unchanged. "
        "Keep xindun GREEN POWER logo, solar-panel background, and all five black "
        "inverter products/LCD screens unchanged. Do not redesign."
    ),
    (3, 0): (
        "Translate diagram overlay labels only to Spanish: "
        "'Soar Panel 300W (10PCS)'→'Panel solar 300W (10PCS)'; "
        "'Battery 100AH (4PCS)'→'Batería 100AH (4PCS)'; "
        "'Solar inverter (1PCS)'→'Inversor solar (1PCS)'; "
        ...
        "Keep white background, red dashed arrows, icons, appliance photos, "
        "xindun GREEN POWER logo, and product LCD unchanged. Do not redesign."
    ),
    (3, 1): (
        "Translate diagram circle labels only to Spanish: "
        "'AC'→'CA'; 'DC'→'CC'. "
        "Keep white background, inverter, solar panels, batteries, generator, "
        "utility pole, appliances, wiring colors, and red URL "
        "https://www.xindun-power.com/ unchanged. Do not redesign."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/faq/no-battery-solar-power-system-and-off-grid-no-battery-solar-inverter.html",
        "title_en": "No battery solar power system and off grid no battery solar inverter",
    },
    {
        "url": "https://www.xindun-power.com/faq/what-is-the-use-of-inverter-triphase-offgrid.html",
        "title_en": "What is the use of inverter triphase offgrid?",
    },
    {
        "url": "https://www.xindun-power.com/faq/what-is-a-split-phase-solar-inverter-charger.html",
        "title_en": "What is a split phase inverter charger?",
    },
    {
        "url": "https://www.xindun-power.com/faq/what-is-the-best-inverter-for-solar-panel.html",
        "title_en": "What is the best inverter for solar panels?",
    },
    {
        "url": "https://www.xindun-power.com/faq/what-is-the-advantage-of-3-phase-igbt-inverter-technology.html",
        "title_en": "What is the advantage of 3 phase igbt inverter technology?",
    },
]
