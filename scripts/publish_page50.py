#!/usr/bin/env python3
"""Publish xindun-power news page 50 articles to Spanish WordPress (cat 89)."""
...
# Compress-only: product lineup catalogue photo (0,0); install photo with casing text (2,2);
# MPPT internal product photo (4,1).
DUOMI_MAP = {
    (1, 0): (
        "Translate all English notice text on the red Chinese New Year poster to Spanish: "
        "'CHINESE NEW YEAR HOLIDAYS NOTICE'→'AVISO DE VACACIONES DEL AÑO NUEVO CHINO'; "
        "'HAPPY NEW YEAR'→'FELIZ AÑO NUEVO'; "
        "Translate the three body paragraphs, holiday dates "
        "('Holiday time: January 23 to February 8, 2022', "
        "'Start time: February 9th formally go to work'), "
        "and closing date line to Spanish. "
        "Keep xindun GREEN POWER logo, Guangdong Xindun Power Technology Co., Ltd., "
        "Xindun Power company name, QR code, red/gold decorative layout unchanged. "
        "Do not redesign."
    ),
    (2, 0): (
        "Translate left-side marketing text only to Spanish: "
        "'Product Features :'→'Características del producto:'; "
        "'Pure sine wave output dc to ac'→'Salida de onda senoidal pura de CC a CA'; "
        "'Support RS485 communication port/APP'→'Compatible con puerto de comunicación RS485/APP'; "
        "'AC first/DC first/energy saving mode'→'Modo CA primero/CC primero/ahorro de energía'; "
        "'Low frequency, high efficiency'→'Baja frecuencia, alta eficiencia'; "
        "'Integrated LCD display The display can be external'→"
        "'Pantalla LCD integrada; la pantalla puede ser externa'; "
        "'Built in PWM or MPPT controller'→'Controlador PWM o MPPT incorporado'. "
        "Keep xindun GREEN POWER logo, product photo, city night background, "
        "and https://www.xindun-power.com/ URL unchanged. Do not redesign."
    ),
    (2, 1): (
        "Translate diagram overlay text only to Spanish: "
        "'Pure sine wave'→'Onda senoidal pura'. "
        "Keep U/t graph axes, sine wave curve, oscilloscope screen, inverter product photo, "
    ...
    (3, 0): (
        ...
        "Keep icons, wiring, inverter product photo, and Xindun logo on battery unchanged. "
        "Do not redesign."
    ),
    (3, 1): (
        "Translate left-side marketing text only to Spanish: "
        "'30000 hours of trouble-free operation inverter manufacturers'→"
        "'Fabricantes de inversores con 30000 horas de funcionamiento sin problemas'; "
        "'100KW hybrid solar inverter'→'Inversor solar híbrido de 100KW'; "
        "'Pure sine wave output'→'Salida de onda senoidal pura'; "
        "'Built in PWM or MPPT charge controller'→"
        "'Controlador de carga PWM o MPPT incorporado'; "
        "'Three phase off grid solar inverter'→'Inversor solar trifásico fuera de red'. "
        "Keep xindun GREEN POWER logo, product photo, city skyline background unchanged. "
        "Do not redesign."
    ),
    (4, 0): (
        "Translate diagram overlay labels only to Spanish: "
        ...
        "'Power Grid or Generator'→'Red eléctrica o Generador'; "
        "'AC Input'→'Entrada CA'; "
        "'AC Output'→'Salida CA'; "
        "'AC Loads'→'Cargas CA'. "
        "Keep xindun GREEN POWER logo, inverter terminal labels (BAT+, SOLAR1+, etc.), "
        "N/L/PE wire labels, appliance icons, and wiring colors unchanged. Do not redesign."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/company-news/Xindun-Power-catalogue-2021.html",
        "title_en": "Xindun Power Inverter Catalogue 2021",
    },
    {
        "url": "https://www.xindun-power.com/company-news/xindun-power-chinese-new-year-holidays.html",
        "title_en": "2022 Chinese New Year Holidays Notice",
    },
    {
        "url": "https://www.xindun-power.com/faq/The-best-Inverter-and-Battery.html",
        "title_en": "The best Inverter and Battery Combination for Home",
    },
    {
        "url": "https://www.xindun-power.com/faq/What-is-100kw-hybrid-solar-inverter-price-in-bangladesh.html",
        "title_en": "What is 100kw hybrid solar inverter price in bangladesh?",
    },
    {
        "url": "https://www.xindun-power.com/faq/What-is-mppt-solar-inverter.html",
        "title_en": "What is mppt solar inverter?",
    },
]
