#!/usr/bin/env python3
"""Publish xindun-power news page 51 articles to Spanish WordPress (cat 89)."""
...
RESULTS_PATH = Path("/tmp/page51_results.json")
...
# Compress-only: product casing showcase (0,0); factory photo (1,1); jhb city/reception/product photos (2,*);
# product photo (3,0); landscape/house photos (4,*).
DUOMI_MAP = {
    (0, 1): (
        ...
        "'Laptop'→'Portátil'. "
        "Keep inverter product photo, wiring colors, and appliance icons unchanged. Do not redesign."
    ),
    (1, 0): (
        "Translate marketing overlay text only to Spanish: "
        "'3 pahse ups'→'UPS trifásico'; "
        "'3-Phase'→'Trifásico'; "
        "'3KW-160KW' stays the same. "
        "Keep xindun logo, UPS products, appliances, and website URL unchanged. Do not redesign."
    ),
    (3, 1): (
        "Translate PWM controller diagram labels only to Spanish: "
        "'Solar Panels'→'Paneles solares'; "
        "'Solar Controller'→'Controlador solar'; "
        "'Small house usage (12V/24V/48V)'→'Uso en casas pequeñas (12V/24V/48V)'; "
        "'Batteries'→'Baterías'; "
        "'DC Loads'→'Cargas CC'; "
        "'PWM controller'→'Controlador PWM'; "
        "'Villa usage (96V/192V/216V/)'→'Uso en villas (96V/192V/216V/)'; "
        "'Industrial generation usage (384V)'→'Uso industrial (384V)'. "
        "Keep product casing text, Chinese display text, and Xindun battery logos unchanged."
    ),
    (3, 2): (
        "Translate MPPT controller diagram labels only to Spanish: "
        "'Mppt controller'→'Controlador MPPT'; "
        "'Solar Panels'→'Paneles solares'; "
        "'Solar Controller'→'Controlador solar'; "
        "'Batteries'→'Baterías'; "
        "'DC Loads'→'Cargas CC'. "
        "Keep 'MPPT Solar Charge Controller' casing text and battery logos unchanged."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/faq/Why-do-i-need-a-pure-sine-wave-inverter.html",
        "title_en": "Why do i need a pure sine wave inverter",
    },
    {
        "url": "https://www.xindun-power.com/faq/How-to-choose-3-phase-ups-manufacturers.html",
        "title_en": "How to choose 3 phase ups manufacturers?",
    },
    {
        "url": "https://www.xindun-power.com/faq/Looking-for-companies-in-jhb-south-that-sells-inverters.html",
        "title_en": "Looking for companies in jhb south that sells inverters",
    },
    {
        "url": "https://www.xindun-power.com/faq/Different-between-solar-inverter-and-charge-controller.html",
        "title_en": "Different between solar inverter and charge controller",
    },
    {
        "url": "https://www.xindun-power.com/faq/How-to-choose-inverter-capacity.html",
        "title_en": "How to choose inverter capacity?",
    },
]
