#!/usr/bin/env python3
"""Publish xindun-power news page 45 articles to Spanish WordPress (cat 89)."""
...
RESULTS_PATH = Path("/tmp/page45_results.json")
...
# Compress-only: Kenya expo exhibition photos (0,*); install field/indoor photos (2,*);
# product composite with no English overlay (3,0); product showcase casing-only (4,0);
# factory walkthrough photo (4,1).
DUOMI_MAP = {
    (1, 0): (
        "Translate marketing overlay only to Spanish: "
        "'China Inverter Factory'→'Fábrica de inversores de China'. "
        "Keep xindun GREENPOWER logo, house/solar-panel background, and product casing "
        "text ('SOLAR POWER STATION', 'AC OUT', 'DC INPUT') unchanged. Do not redesign."
    ),
    (3, 1): (
        "Translate diagram overlay labels only to Spanish: "
        "'Solar Panels'→'Paneles solares'; "
        "'PV and the mains complementary storage inverter'"
        "→'Inversor de almacenamiento complementario FV y red'; "
        "'Generator'→'Generador'; "
        "'or'→'o'; "
        "'Power Grid'→'Red eléctrica'; "
        "'AC Loads'→'Cargas CA'. "
        "Keep white background, red dashed arrows, icons, appliance photos, and product "
        "casing text ('SOLAR INVERTER', LCD readouts) unchanged. Do not redesign."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/company-news/kenya-solar-energy-expo-2022.html",
        "title_en": "Xindun Power made appearance at the 7th Kenya Solar Energy Expo 2022",
    },
    {
        "url": "https://www.xindun-power.com/faq/function-of-solar-inverter-off-grid.html",
        "title_en": "What is the function of solar inverter off grid?",
    },
    {
        "url": "https://www.xindun-power.com/faq/install-solar-inverter-indoor-or-outdoor.html",
        "title_en": "Is it better to install solar inverter indoor or outdoor?",
    },
    {
        "url": "https://www.xindun-power.com/faq/How-to-use-solar-inverter-without-battery.html",
        "title_en": "How to use solar inverter without battery？",
    },
    {
        "url": "https://www.xindun-power.com/faq/top-10-solar-inverter-manufacturers-in-the-world-2021.html",
        "title_en": "Top 10 solar inverter manufacturers in the world 2021",
    },
]
