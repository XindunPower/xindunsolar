#!/usr/bin/env python3
"""Publish xindun-power news page 84 articles to Spanish WordPress (cat 89)."""
...
TITLE_OVERRIDES = {
    "How high-frequency inverters solve the problem of mobile power supply?": (
        "¿Cómo resuelven los inversores de alta frecuencia el problema de la alimentación móvil?"
    ),
    "Which brand of high power pure sine wave inverter is better?": (
        "¿Qué marca de inversor de onda sinusoidal pura de alta potencia es mejor?"
    ),
    "How to choose safe inverters?": "¿Cómo elegir inversores seguros?",
    "How to use low frequency inverter?": "¿Cómo utilizar un inversor de baja frecuencia?",
    "Is there an inverter that can invert 380v?": "¿Existe un inversor que pueda invertir 380 V?",
}

ALT_OVERRIDES = {
    "high frequency inverter": "inversor de alta frecuencia",
    "High power inverter brand": "marca de inversor de alta potencia",
    "inverters": "inversores",
    "low frequency inverter": "inversor de baja frecuencia",
    "380v inverter": "inversor de 380 V",
}
