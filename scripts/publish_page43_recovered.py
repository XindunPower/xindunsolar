#!/usr/bin/env python3
"""Publish xindun-power news page 43 articles to Spanish WordPress (cat 89)."""
...
RESULTS_PATH = Path("/tmp/page43_results.json")
...
# Compress-only: (1,1) product showcase with casing/logos only (no overlay text).
DUOMI_MAP = {
    (0, 0): (
        "Translate diagram overlay labels only to Spanish: "
        "'DC To AC Inverter'→'Inversor de CC a CA'; "
        "'Solar Panel'→'Panel solar'; "
        "'Solar Charge Controller'→'Controlador de carga solar'; "
        "'Battery'→'Batería'; "
        "'DC & AC Appliances'→'Electrodomésticos de CC y CA'. "
        "Keep voltages 12V/240V, arrows, icons, and product casing text "
        "('SOLAR INVERTER', logos) unchanged. Do not redesign."
    ),
    (1, 0): (
        "Translate marketing overlays only to Spanish: "
        "'Standby Solar Generator'→'Generador solar de respaldo'; "
        "'AC Grid'→'Red CA'. "
        "Keep day/night split, products, Xindun logos, and product casing text "
        "('ALL IN ONE SOLAR GENERATOR') unchanged. Do not redesign."
    ),
    (2, 0): (
        "Translate all diagram section titles and labels to Spanish: "
        "'Off-Grid Solar System'→'Sistema solar fuera de la red'; "
        "'On-Grid Solar System'→'Sistema solar conectado a la red'; "
        "'Hybrid Solar System'→'Sistema solar híbrido'; "
        "'Solar Panel'→'Panel solar'; 'Inverter'→'Inversor'; "
        "'Battery Bank'→'Banco de baterías'; "
        "'Home/Office/School'→'Hogar/Oficina/Escuela'; "
        "'Utility Meter'→'Medidor de utilidad'; "
        "'Power Grid'→'Red eléctrica'. "
        "Keep three-panel layout, colors, icons, arrows, and product photos identical."
    ),
    (3, 0): (
        "Translate diagram labels only to Spanish: "
        "'Off-Grid'→'Fuera de la red'; 'On-Grid'→'Conectada a la red'; "
        "'Solar Panel'→'Panel solar'; 'Inverter'→'Inversor'; "
        "'Battery Bank'→'Banco de baterías'; "
        "'Generator (Optional)'→'Generador (Opcional)'; "
        "'Utility Meter'→'Medidor'; 'Grid'→'Red eléctrica'. "
        "Keep split yellow/green layout, icons, arrows, and inverter photos identical."
    ),
    (3, 1): (
        "Translate diagram overlay labels only to Spanish: "
        "'ZRS Inverter'→'Inversor ZRS'; "
        "'Power Grid'→'Red eléctrica'; "
        "'Solar Panel'→'Panel solar'; "
        "'Battery'→'Batería'; "
        "'AC Loads'→'Cargas CA'. "
        "Keep red dashed lines, green icons, white background, and product casing "
        "('SOLAR INVERTER', Xindun logo) unchanged. Do not redesign."
    ),
    (4, 0): (
        "Translate diagram overlay labels only to Spanish: "
        "'Solar Panels'→'Paneles solares'; "
        "'Solar On/Off Grid Inverter'→'Inversor solar on/off grid'; "
        "'Batteries'→'Baterías'; "
        "'Electric Meter'→'Medidor eléctrico'; "
        "'Power Grid'→'Red eléctrica'; "
        "'or'→'o'; "
        "'Generator'→'Generador'; "
        "'Uninterrupted Power Supply'→'Suministro de energía ininterrumpida'. "
        "Keep xindun GREEN POWER logo, city/solar-farm background, red dashed arrows, "
        "icons, and product casing text ('STORAGE Power Inverter', XD200-12) unchanged."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/faq/how-to-convert-12v-dc-to-240v-ac-power.html",
        "title_en": "How to convert 12v dc to 240v ac power?",
    },
    {
        "url": "https://www.xindun-power.com/faq/home-standby-solar-generator-for-rural-areas.html",
        "title_en": "Home standby solar generator for rural areas",
    },
    {
        "url": "https://www.xindun-power.com/faq/difference-between-off-grid-on-grid-and-hybrid-inverter.html",
        "title_en": "Differences between off grid,on grid and hybrid inverter",
    },
    {
        "url": "https://www.xindun-power.com/faq/can-i-use-solar-panel-and-inverter-without-battery.html",
        "title_en": "Can I Use Solar Panel and Inverter Without Battery?",
    },
    {
        "url": "https://www.xindun-power.com/faq/how-does-a-hybrid-on-off-grid-inverter-work.html",
        "title_en": "How does a hybrid on off grid inverter work?",
    },
]
