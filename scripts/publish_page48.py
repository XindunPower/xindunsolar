#!/usr/bin/env python3
"""Publish xindun-power news page 48 articles to Spanish WordPress (cat 89)."""
...
RESULTS_PATH = Path("/tmp/page48_results.json")
...
# Compress-only: product showcase casing (0,0); generator casing photos (2,0)(2,1);
# landscape+URL (4,0); product lineup casing+URL (4,1).
DUOMI_MAP = {
    (1, 0): (
        "Translate left-side marketing text only to Spanish: "
        "'100KVA solar power system'→'Sistema de energía solar 100KVA'; "
        "'configurations:'→'configuraciones:'; "
        "'1. three phase solar inverter'→'1. inversor solar trifásico'; "
        "'2. MONO solar panels'→'2. paneles solares MONO'; "
        "'3. 2 PCS 384V 100A MPPT'→'3. 2 PCS 384V 100A MPPT'; "
        "'4. 96PCS 12V 200AH gel batteries'→'4. 96PCS baterías de gel 12V 200AH'; "
        "'5. 4PCS PV combiner(2 in 1 out)'→'5. 4PCS combinador FV (2 en 1 salida)'; "
        "'6. solar Panel Mounting Rack'→'6. estructura de montaje de paneles solares'. "
        "Keep xindun GREENPOWER logo, all product photos on the right, "
        "and gradient background unchanged. Do not redesign."
    ),
    (1, 1): (
        "Translate diagram overlay labels only to Spanish: "
        "'Solar Panels'→'Paneles solares'; "
        "'Solar Combiner Box'→'Caja combinadora solar'; "
        "'Solar Inverter'→'Inversor solar'; "
        "'Solar Charge Controller'→'Controlador de carga solar'; "
        "'Batteries'→'Baterías'; "
        "'Power grid'→'Red eléctrica'. "
        "Keep house, sun, wiring colors, product photos, and "
        "xindun GREEN POWER logo unchanged. Do not redesign."
    ),
    (3, 0): (
        ...
        "'DC'→'CC'; "
        "'AC'→'CA'; "
        "'The current magnitude and direction are the same'→"
        "'La magnitud y dirección de la corriente son iguales'; "
        "'The current magnitude and direction change periodically'→"
        "'La magnitud y dirección de la corriente cambian periódicamente'. "
        "Keep black background, product photo, orange arrows, graphs, "
        "and POWER INVERTER W9 casing text unchanged. Do not redesign."
    ),
}

ARTICLES = [
    {
        "url": "https://www.xindun-power.com/faq/what-is-a-hybrid-solar-inverter.html",
        "title_en": "what is a hybrid solar inverter ?",
    },
    {
        "url": "https://www.xindun-power.com/faq/How-Much-is-a-Complete-100KVA-Solar-Power-System.html",
        "title_en": "How Much is a Complete 100KVA Solar Power System?",
    },
    {
        "url": "https://www.xindun-power.com/faq/What-things-do-I-need-to-install-solar-system-for-my-house.html",
        "title_en": "What things do I need to install solar system for my house",
    },
    {
        "url": "https://www.xindun-power.com/faq/The-application-of-inverter.html",
        "title_en": "The application of power inverters",
    },
    {
        "url": "https://www.xindun-power.com/faq/solar-inverters-for-sale-in-zimbabwe.html",
        "title_en": "solar inverters for sale in zimbabwe",
    },
]
