#!/usr/bin/env python3
"""Publish xindun-power news page 80 articles to Spanish WordPress (cat 89)."""
...
# Page 80 re-lists articles from pages 78–79; Duomi map only needed if republishing.
base.DUOMI_MAP = {
    (0, 0): (
